    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-3 lg:grid-cols-4">
        <OutcomeCard
          ...
          detail="Candidates evaluated against the approved rubric"
        />
        <OutcomeCard
          label="Recommended"
          value={recommendedCount.toString()}
          detail="Strong Hire or Hire candidates to prioritize"
        />
        <OutcomeCard
          label="Follow-up risks"
          value={followUpRiskCount.toString()}
...
function OutcomeCard({
  ...
  return (
    <div className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
      <p className="text-sm font-bold uppercase tracking-[0.14em] text-zinc-500">{label}</p>
